...
impl VGAMiscOutputRegister{
    #[inline(always)]
    pub unsafe fn write(&mut self, data: u8) { self.writing.write(data); }

    #[inline(always)]
    pub unsafe fn read(&self) -> u8{ self.reading.read() }
}
...
const TEXT_80X25: VgaModeDump = VgaModeDump{
    ...
    crtc_controller_registers: &[(0x00, 0x5F), (0x01, 0x4F), (0x02, 0x50), (0x03, 0x82), (0x04, 0x55), (0x05, 0x81), (0x06, 0xBF), (0x07, 0x1F), (0x08, 0x00), (0x09, 0x4F), (0x0A, 0x0D), (0x0B, 0x0E), (0x0C, 0x00), (0x0D, 0x00), (0x0E, 0x00), (0x0F, 0x50), (0x10, 0x9C), (0x11, 0x0E), (0x12, 0x8F), (0x13, 0x28), (0x14, 0x1F), (0x15, 0x96), (0x16, 0xB9), (0x17, 0xA3), (0x18, 0xFF)],
    attribute_controller_registers_mixed: &[(0x00, 0x00), (0x01, 0x01), (0x02, 0x02), (0x03, 0x03), (0x04, 0x04), (0x05, 0x05), (0x06, 0x14), (0x07, 0x07), (0x08, 0x38), (0x09, 0x39), (0x0A, 0x3A), (0x0B, 0x3B), (0x0C, 0x3C), (0x0D, 0x3D), (0x0E, 0x3E), (0x0F, 0x3F), (0x10, 0x0C), (0x11, 0x00), (0x12, 0x0F), (0x13, 0x08), (0x14, 0x00)],
...
pub const FANCY_PALETTE: [(u8, u8, u8); 256] = [(0x0, 0x0, 0x0), (0x0, 0x0, 0xc), (0x0, 0x0, 0x18), (0x0, 0x0, 0x24), (0x0, 0x0, 0x30), (0x0, 0x0, 0x3c), (0x0, 0xa, 0x0), (0x0, 0xa, 0xc), (0x0, 0xa, 0x18), (0x0, 0xa, 0x24), (0x0, 0xa, 0x30), (0x0, 0xa, 0x3c), (0x0, 0x14, 0x0), (0x0, 0x14, 0xc), (0x0, 0x14, 0x18), (0x0, 0x14, 0x24), (0x0, 0x14, 0x30), (0x0, 0x14, 0x3c), (0x0, 0x1e, 0x0), (0x0, 0x1e, 0xc), (0x0, 0x1e, 0x18), (0x0, 0x1e, 0x24), (0x0, 0x1e, 0x30), (0x0, 0x1e, 0x3c), (0x0, 0x28, 0x0), (0x0, 0x28, 0xc), (0x0, 0x28, 0x18), (0x0, 0x28, 0x24), (0x0, 0x28, 0x30), (0x0, 0x28, 0x3c), (0x0, 0x32, 0x0), (0x0, 0x32, 0xc), (0x0, 0x32, 0x18), (0x0, 0x32, 0x24), (0x0, 0x32, 0x30), (0x0, 0x32, 0x3c), (0x0, 0x3c, 0x0), (0x0, 0x3c, 0xc), (0x0, 0x3c, 0x18), (0x0, 0x3c, 0x24), (0x0, 0x3c, 0x30), (0x0, 0x3c, 0x3c), (0xc, 0x0, 0x0), (0xc, 0x0, 0xc), (0xc, 0x0, 0x18), (0xc, 0x0, 0x24), (0xc, 0x0, 0x30), (0xc, 0x0, 0x3c), (0xc, 0xa, 0x0), (0xc, 0xa, 0xc), (0xc, 0xa, 0x18), (0xc, 0xa, 0x24), (0xc, 0xa, 0x30), (0xc, 0xa, 0x3c), (0xc, 0x14, 0
pub const DEFAULT_PALETTE: [(u8, u8, u8); 256] = [
    ...
    (0x0, 0x2A, 0x3F), (0x2A, 0x0, 0x15), (0x2A, 0x0, 0x3F), (0x2A, 0x2A, 0x15), (0x2A, 0x2A, 0x3F), 
    (0x0, 0x15, 0x0), (0x0, 0x15, 0x2A), (0x0, 0x3F, 0x0), (0x0, 0x3F, 0x2A), (0x2A, 0x15, 0x0), (0x2A, 0x15, 0x2A), 
    (0x2A, 0x3F, 0x0), (0x2A, 0x3F, 0x2A), (0x0, 0x15, 0x15), (0x0, 0x15, 0x3F), (0x0, 0x3F, 0x15), 
    (0x0, 0x3F, 0x3F), (0x2A, 0x15, 0x15), (0x2A, 0x15, 0x3F), (0x2A, 0x3F, 0x15), (0x2A, 0x3F, 0x3F), 
    (0x15, 0x0, 0x0), (0x15, 0x00, 0x2A), (0x15, 0x2A, 0x00), (0x15, 0x2A, 0x2A), (0x3F, 0x00, 0x00), (0x3F, 0x00, 0x2A), 
    (0x3F, 0x2A, 0x00), (0x3F, 0x2A, 0x2A), (0x15, 0x00, 0x15), (0x15, 0x00, 0x3F), (0x15, 0x2A, 0x15), (0x15, 0x2A, 0x3F), 
    (0x3F, 0x00, 0x15), (0x3F, 0x00, 0x3F), (0x3F, 0x2A, 0x15), (0x3F, 0x2A, 0x3F), (0x15, 0x15, 0x00), (0x15, 0x15, 0x2A), 
    (0x15, 0x3F, 0x00), (0x15, 0x3F, 0x2A), (0x3F, 0x15, 0x00), (0x3F, 0x15, 0x2A), (0x3F, 0x3F, 0x00), (0x3F, 0x3F, 0x2A), 
    (0x15, 0x15, 0x15), (0x15, 0x15, 0x3F), (0x15, 0x3F, 0x15), (0x15, 0x3F, 0x3F), (0x3F, 0x15, 0x15), (0x3F, 0x15, 0x3F),
    (0x3F, 0x3F, 0x15), (0x3F, 0x3F, 0x3F), (0x3F, 0x3F, 0x3F), (0x3F, 0x3F, 0x3F), (0x3F, 0x3F, 0x3F), (0x3F, 0x3F, 0x3F), 
...
impl<T: VgaMode + 'static> Vga<T, Blanked>{
    ...
    pub unsafe fn set_mode<U: VgaMode + 'static>(mut self) -> Vga<U, Blanked>{
            if core::any::TypeId::of::<U>() == core::any::TypeId::of::<T>() { return self.typestate_transmute::<U>() }
    ...
    unsafe fn load_mode_dump(&mut self, dump: &VgaModeDump){
            ...
            dump.graphics_controller_registers.iter().for_each(|(index, val)| self.graphics_controller_registers.write(*index as u8, *val));
            dump.attribute_controller_registers_mixed.iter().for_each(|(index, val)| self.attribute_controller_registers_mixed.write(*index as u8, *val));
    }
    ...
    unsafe fn load_font<const SIZE: usize>(&mut self, font: &[u8; SIZE], char_height: u8, offset: isize){
        ...
        for c_ind in 0..n_chars {
            for row in 0..char_height {
                self.video_ram.offset(32*c_ind as isize + row as isize + offset).write(font[c_ind*char_height as usize+row as usize]);
            }
        }
        // Restore state
