    ...
    unsafe fn dealloc(&self, ptr: *mut u8, layout: core::alloc::Layout) {
        ...
        if !did_dealloc {
            ...
            for i in 0..s.stashed_deallocations.len() {
                ...
                if stashed_dealloc.0 == null_mut() { break; } // If the failed deallocation with the highest address is null, then obv. all other deallocations are null as well (a.k.a there are no more deallocations to consider)
