...
pub fn init(r1: usize, r2: usize) -> &'static [u32] {
    ...
    if r1 != 0x36d76289 { panic!("Kernel was not booted by a multiboot-compatible bootloader! ") }
    unsafe{core::slice::from_raw_parts(core::mem::transmute::<_, *const u32>(r2).offset(2), (*core::mem::transmute::<_, *const u32>(r2) as usize) / core::mem::size_of::<u32>() )}
}